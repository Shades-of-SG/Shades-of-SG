...
const Song = sequelize.define('Song', {
    ...
    otherLanguages: { type: DataTypes.JSON, allowNull: false, defaultValue: [], field: 'other_languages' },
    moodTags: { type: DataTypes.JSON, allowNull: false, defaultValue: [], field: 'mood_tags' },
    rawLyrics: { type: DataTypes.TEXT, allowNull: true, field: 'raw_lyrics' },
    ...
    publishedDate: { type: DataTypes.DATE, allowNull: true, field: 'published_date' },
