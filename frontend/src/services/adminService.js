...
export const getAdminUser = (id, token) => platformRequest(`/admin/users/${encodeURIComponent(id)}`, { token })
export const getAdminUserCreatorStats = (id, token) => platformRequest(`/admin/users/${encodeURIComponent(id)}/creator-stats`, { token })
export const updateAdminUserEmail = (id, values, token) => platformRequest(`/admin/users/${encodeURIComponent(id)}/email`, jsonOptions('PATCH', values, token))
export const sendAdminPasswordResetLink = (id, adminPassword, token) => platformRequest(`/admin/users/${encodeURIComponent(id)}/password-reset-link`, jsonOptions('POST', { adminPassword }, token))
export const deleteAdminUser = (id, values, token) => platformRequest(`/admin/users/${encodeURIComponent(id)}`, jsonOptions('DELETE', values, token))
