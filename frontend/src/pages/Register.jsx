...
//import { registerAccount } from '../services/authApi' //Where is this even being used? I have no more conflicts??
...
//lia.otp.start
import { registerAccount, sendEmailOtp, verifyEmailOtp, registerWithEmail, checkNameAvailability, checkEmailAvailability } from '../services/authApi'
//lia.otp.end
