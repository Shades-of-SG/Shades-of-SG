...
import { clearScoreClaimReturn, readRegistrationReturn, RHYTHM_SCORE_CLAIM_PATH, safeReturnPath, storeRegistrationReturn } from '../services/safeReturnPath'
...
export default function OtpVerification() {
  ...
  async function verify(event) {
    ...
    try {
      ...
      if (returnPath === RHYTHM_SCORE_CLAIM_PATH) navigate(returnPath, { replace: true })
      else {
