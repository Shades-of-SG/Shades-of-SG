...
export default function ProfileHero({ editable = true, isCreator = false, onOpenCreatorProfile, profile = {} }) {
  ...
  return (
    <section className="profile-hero">
      ...
      {editable ? <div className="profile-hero__actions"><Link className="profile-button profile-hero__edit" to="/settings#profile"><Pencil aria-hidden="true" size={15} /> Edit Profile</Link>{isCreator && onOpenCreatorProfile ? (<button className="profile-button profile-button--soft" onClick={onOpenCreatorProfile} type="button"><Sparkles aria-hidden="true" size={15} /> Creator profile</button>) : null}</div> : null}
